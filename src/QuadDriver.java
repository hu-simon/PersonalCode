//We first import two important classes that we're going to be using throughout the code 
//First, the scanner class so that we can ask the user for input
//Second, the Math class, so that we may use the .sqrt() method
